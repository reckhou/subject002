...
public class GameController : MonoBehaviour
{
  ...
  void LogicReport ()
  {
    ...
    StartCoroutine ("ReportTimer", 7.0f);
  }
...
//			WaitForSeconds(5);
  ...
  public void Update ()
  {
    ...
    if (NextStep == LogicStep.PostReport) {
      ...
      if (reportTextController.AllTextPlayed ()) {
        if (!reportWaiting && Input.anyKeyDown) {
          StartCoroutine ("ReportTimer", 2.0f);
        }
  ...
  IEnumerator ReportTimer (float waitTime)
  {
    reportWaiting = true;
